...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        # Obstacle 3
        self.obstacle3 = self.canvas_widget.create_image(pixels * 2, 0, anchor='nw', image=self.obstacle5_object)
        # Obstacle 4
        ...
        # Obstacle 9
        self.obstacle9 = self.canvas_widget.create_image(pixels * 9, 0, anchor='nw', image=self.obstacle4_object)
        # Obstacle 10
        self.obstacle10 = self.canvas_widget.create_image(pixels * 8, 0 , anchor='nw', image=self.obstacle4_object)
        # Obstacle 11
        self.obstacle11 = self.canvas_widget.create_image(pixels * 9, pixels * 5, anchor='nw', image=self.obstacle4_object)
        # Obstacle 12
        self.obstacle12 = self.canvas_widget.create_image(pixels * 8, 0 , anchor='nw', image=self.obstacle4_object)
        # Obstacle 13
        ...
        # Obstacle 15
        self.obstacle15 = self.canvas_widget.create_image(pixels * 6, pixels * 4, anchor='nw', image=self.obstacle1_object)
        # Obstacle 16
        self.obstacle16 = self.canvas_widget.create_image(pixels * 7, 0, anchor='nw', image=self.obstacle3_object)
        # Obstacle 17
        self.obstacle17 = self.canvas_widget.create_image(pixels * 7, pixels , anchor='nw', image=self.obstacle4_object)
        # Obstacle 18
        ...
        # Obstacle 20
        self.obstacle20 = self.canvas_widget.create_image(pixels * 7, pixels * 2, anchor='nw', image=self.obstacle4_object)
        # Obstacle 21
        self.obstacle21 = self.canvas_widget.create_image(pixels * 8, pixels * 2, anchor='nw', image=self.obstacle4_object)
        # Obstacle 22
        self.obstacle22 = self.canvas_widget.create_image(pixels * 4, pixels * 3, anchor='nw', image=self.obstacle2_object)
        # Obstacle 23
        self.obstacle23 = self.canvas_widget.create_image(pixels * 7, pixels * 5, anchor='nw', image=self.obstacle10_object)
        # Obstacle 24
        self.obstacle24 = self.canvas_widget.create_image(pixels * 5, pixels * 7, anchor='nw', image=self.obstacle9_object)
        # Obstacle 25
        self.obstacle25 = self.canvas_widget.create_image(pixels * 6, pixels * 6, anchor='nw', image=self.obstacle6_object)
        # Obstacle 26
        self.obstacle26 = self.canvas_widget.create_image(pixels * 5, pixels * 8, anchor='nw', image=self.obstacle4_object)
        # Obstacle 27
        self.obstacle27 = self.canvas_widget.create_image(pixels * 8, pixels * 7, anchor='nw', image=self.obstacle3_object)
        # Obstacle 28
        self.obstacle28 = self.canvas_widget.create_image(pixels * 9, pixels * 9, anchor='nw', image=self.obstacle2_object)
       
        # Final Point
        img_flag = Image.open("images/flag.png")
        self.flag_object = ImageTk.PhotoImage(img_flag)
        self.flag = self.canvas_widget.create_image(pixels * 9, pixels , anchor='nw', image=self.flag_object)
